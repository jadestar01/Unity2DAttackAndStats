...
namespace dmg
{
    public class DamageCalculator : MonoBehaviour
    {
        ...
        public Damage DmgCal(GameObject main, GameObject target, SkillDamage skillProfile)
        {
            ...
            if (main.tag == "Player")
            {
                ...
                if (Random.Range(0, 100) < defender.dodge && skillProfile.canDodge == true)
                {
                    Debug.Log("회피함!");
                    return new Damage { isDodge = true, totalDamage = 0 };
                }
                ...
                bool isPhysicalCrit = Random.Range(0, 101) < (attacker.physicalCritRate + skill.extraPhysicalCritRate) ? true : false;
                if (PhysicalDmg != 0)
                {
                ...
                bool isMagicalCrit = Random.Range(0, 101) < (attacker.magicalCritRate + skill.extraMagicalCritRate) ? true : false;
                if (MagicalDmg != 0)
                {
                    if (isMagicalCrit)
                    {
    ...
    {
        public bool canDodge;                       //회피 가능한 기술인가?
        ...
        public void DmgCal(GameObject subject)
        {
            ...
            if (subject.tag == "Player")
            {
                ...
                if (physical.physicalDmg != 0)
                    extraPhysicalDmg += (int)((Random.Range(attacker.physicalMinDmg, attacker.physicalMaxDmg + 1) * physical.physicalDmg));
                ...
                if (physical.magicalDmg != 0)
                    extraPhysicalDmg += (int)((Random.Range(attacker.magicalMinDmg, attacker.magicalMaxDmg + 1) * physical.magicalDmg));
                ...
                if (magical.physicalDmg != 0)
                    extraMagicalDmg += (int)((Random.Range(attacker.physicalMinDmg, attacker.physicalMaxDmg + 1) * magical.physicalDmg));
                ...
                if (magical.magicalDmg != 0)
                    extraMagicalDmg += (int)((Random.Range(attacker.magicalMinDmg, attacker.magicalMaxDmg + 1) * magical.magicalDmg));
